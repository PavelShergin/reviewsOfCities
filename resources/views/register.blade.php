            ...
            <div class="container_reg">
                <div class="signup-content">
                    <form method="POST" action="{{route('create_user')}}" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-input" name="password_confirmation" id="re_password"
                        ...
                        <div class="form-group">
                            <button type="submit" name="submit" id="submit" class="form-submit">Зарегистрироваться
                            </button>
                        </div>
                    </form>
                    <p class="loginhere">
