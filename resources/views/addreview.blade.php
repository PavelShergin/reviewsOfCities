...
@section('content')
    @if(isset($review))
        <form method="POST" action="{{route('update',$review->id)}}" class="col-lg-6 offset-lg-3 mt-5"
              enctype="multipart/form-data">
            @else
                <form method="POST" action="{{route('store_review')}}" class="col-lg-6 offset-lg-3 mt-5"
                      enctype="multipart/form-data">
                    @endif
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8 mt-2">
                            @if(isset($review))
                                <textarea id="textarea" name="text" cols="40" rows="5"
                    ...
                    <div class="form-group row mt-2 ">
                        ...
                        <div class="col-8 mt-2">
                            @if(isset($review))
                                <input id="basic" name="city" type="text" value="@isset($city){{$city->name}} @endisset"
                ...
                <script
                    src="https://cdn.jsdelivr.net/gh/tomik23/autocomplete@1.8.5/dist/js/autocomplete.min.js"></script>
